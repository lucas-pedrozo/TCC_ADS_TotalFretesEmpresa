...
import { maskCep, maskPhone, normalizePhoneInput } from "@/utils/mask";

type ProfileTab = "company" | "address";
...
const PerfilPage = () => {
  ...
  const formattedPhone = useMemo(
    () => maskPhone(livePhone ?? "") || t("pages.profile.phoneFallback"),
    [livePhone, t]
  );
            ...
            <div className="flex min-w-0 items-center gap-4">
              ...
              <div className="min-w-0 space-y-2 pt-8 md:pt-0">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge
                    variant="outline"
                    className="gap-1 rounded-full border-brand-green/30 bg-brand-green-light/30 px-2.5 text-brand-green-dark"
                  >
                    <CheckCircle2 className="size-3.5" />
                    {t("pages.profile.companyBadge")}
                  </Badge>
                </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                >
                  <Input
                    ...
                    className="h-11 rounded-xl"
                    autoComplete="off"
                    {...register("birthFundation", rules.birthFundation)}
                  />
                </ProfileField>
