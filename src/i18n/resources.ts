    ...
    translation: {
      ...
      pages: {
        ...
        freights: {
          ...
          filterPanelHint:
            "Combine status, valores, peso, distância e motorista. Deixe em branco para ignorar o critério.",
          ...
          filterSectionWeight: "Peso da carga (kg)",
          filterWeightHelp: "Conforme o tipo de carga. Sem peso cadastrado é ocultado ao filtrar.",
    ...
    translation: {
      ...
      pages: {
        ...
        freights: {
          ...
          filterPanelHint:
            "Combine status, amounts, weight, distance and driver. Leave blank to skip a criterion.",
          filterSectionStatus: "Status",
          filterSectionValue: "Displayed value",
          filterValueHelp: "Uses final value when set, otherwise initial value.",
          filterSectionWeight: "Cargo weight (kg)",
          filterWeightHelp: "From cargo type. Rows without weight are hidden when filtering.",
